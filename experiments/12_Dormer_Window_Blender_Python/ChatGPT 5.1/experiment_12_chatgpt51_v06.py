# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 12 - CHATGPT 5.1 - V06
# DORMER WINDOW
# ------------------------------------------------------------------
...
def build_dormer_with_host_roof(
    ...
    # ----------------------------------------------------------------
    # 1. Dormer support studs (BACK ONLY – front studs removed)
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 3. Top plates (FRONT ONLY – back plate removed)
    # ----------------------------------------------------------------
    box(
    ...
    # ----------------------------------------------------------------
    # 6. Gable stud FRONT ONLY (back gable stud removed)
    # ----------------------------------------------------------------
    ...
    #    - split below dormer into lower + upper
    #    - upper parts trimmed at the double header (y_ridge_back)
    ...
    #     Shifted by one profile thickness in -Y to avoid intersection
    #     and kept within the dormer roof volume.
    # ----------------------------------------------------------------
