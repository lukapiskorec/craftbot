# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 12 - CHATGPT 5.1 - V05
# DORMER WINDOW
# ------------------------------------------------------------------
...
def build_dormer_with_host_roof(
    ...
    # ----------------------------------------------------------------
    # 1. Dormer support studs (from floor to top plate)
    # ----------------------------------------------------------------
    ...
    #    - split below dormer into lower + upper parts
    ...
    for i, x_pos in enumerate(x_positions):
        ...
        # Rafters under dormer centre are split: lower + upper
        if x_left < x_pos < x_right:
            # lower part: eave -> dormer front
            ...
            # upper part: dormer back -> ridge
            back_pt = (x_pos, back_y, z_back_roof)
            rafter_between(
    ...
    #     (brought back so they connect visually to side studs/rafters)
    # ----------------------------------------------------------------
    ...
    for i, y_pos in enumerate(dormer_rafter_y_positions):
        # Align braces with the dormer rafter/stud lines
        brace_y = y_pos
        box(
