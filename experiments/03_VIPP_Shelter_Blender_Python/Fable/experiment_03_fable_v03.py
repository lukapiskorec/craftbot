...
grid = positions(0.0, L, SPACING, RJ)
grid += [x for x in positions(BOX1_X[0], BOX1_X[1], 0.4, RJ)[1:-1] if all(abs(x - g) > 0.1 for g in grid)]
...
print("VIPP shelter v03 generated:", len([o for o in bpy.data.objects if o.type == "MESH"]), "elements")
