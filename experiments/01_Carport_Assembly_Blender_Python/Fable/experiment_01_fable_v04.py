...
# v04: eave overhang 1.0 m (rafter tails 0.55 m past the tie-beam ends, as in
#      the reference); slab widened to stay under the eaves.
...
SLAB = dict(x=(-1.0, 10.0), y=(-4.2, 4.2), thick=0.15)
...
EAVE_OVERHANG = 1.0                # common rafter tail beyond post centre
