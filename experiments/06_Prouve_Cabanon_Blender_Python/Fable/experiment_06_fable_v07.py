...
OVH_G = 0.90                                 # rail / ridge / tray overhang past the gable walls (7.8 m roof = 13 x 0.6 trays)
YM = W / 2
...
print("experiment_06_fable_v07: built", len([o for o in bpy.data.objects if o.type == "MESH"]), "members")
