# ------------------------------------------------------------------
# CRAFT BOT - Experiment 07 (Fable run) - Gehry-style deconstruction - v04
# ------------------------------------------------------------------
...
print("experiment_07_fable_v04: built", len([o for o in bpy.data.objects if o.type == "MESH"]), "members")
