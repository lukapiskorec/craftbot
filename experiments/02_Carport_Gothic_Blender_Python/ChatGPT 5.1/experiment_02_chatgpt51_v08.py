# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 02 - CHATGPT 5.1 - V08
...
INNER_POST_RATIO = 0.55   # tweak if you want them closer/further from centre
...
def make_bent(index, y):
    ...
    # Knee braces from posts
    add_knee_braces(index, y)

    # Gable truss with inner posts & split eave beam only on end bents
...
# ------------------------------------------------------------------
# GABLE TRUSS (inner posts, split eave beam, upper tie, king, X)
# ------------------------------------------------------------------
