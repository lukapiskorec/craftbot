# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 04 - CHATGPT 5.1 - V03
...
def build_platform():
    ...
    south_bearer_y = y0 + half(POST_SIZE)
    north_bearer_y = y1 - half(POST_SIZE)
...
def build_walls(floor_z):
    ...
    # Plywood sheathing: continuous from floor top to top plate
    ply_base_z = floor_top_z
    ply_height = wall_total_height

    # --- Exterior plywood ---
    # South wall: sheet centre at y_s - STUD_DEPTH/2 - PLY_EXT/2
    add_plywood_wall_x(
        "Ply_S_ext",
        x_w,
        x_e,
    ...
    # --- Interior plywood ---
    # South interior: centre at y_s + STUD_DEPTH/2 - PLY_INT/2
    add_plywood_wall_x(
        "Ply_S_int",
        x_w,
        x_e,
