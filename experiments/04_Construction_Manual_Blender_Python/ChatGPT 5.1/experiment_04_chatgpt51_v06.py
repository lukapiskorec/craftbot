# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 04 - CHATGPT 5.1 - V06
...
def build_walls(floor_z):
    ...
    # Openings data per wall for plywood
    openings_s = [
        {"span": (door_x0, door_x1), "vspan": (door_bottom_z, door_top_z)},
        {"span": (win_s_x0, win_s_x1), "vspan": (win_sill_z, win_head_z)},
    ]
    openings_n = [
        {"span": (win_n_x0, win_n_x1), "vspan": (win_sill_z, win_head_z)},
    ]
    openings_w = [
        {"span": (win_w_y0, win_w_y1), "vspan": (win_sill_z, win_head_z)},
    ]
    openings_e = [
        {"span": (win_e_y0, win_e_y1), "vspan": (win_sill_z, win_head_z)},
    ]
