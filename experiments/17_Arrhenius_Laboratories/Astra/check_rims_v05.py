...
report=runpy.run_path(str(HERE/'snapshot_v05.py'))['identity']()+'\nFROZEN v05 RIM/FRAME CONTACTS; standard SAT gap<=2mm; not bearing-area/capacity verification\n'
...
(HERE/'rim_contacts_v05.txt').write_text(report,encoding='utf-8')
