...
Run in Blender after opening the saved v04 model; this does not alter geometry.
"""
...
tree=ast.parse((HERE/'experiment_17_astra_v04.py').read_text(encoding='utf-8'))
...
(HERE/'headroom_v04.txt').write_text(report,encoding='utf-8')
