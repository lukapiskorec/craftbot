...
for number,plane,extents,title,notes in sections:
    ...
    svg.append('</svg>')
    (HERE/f'plan_v06_support_{number}.svg').write_text('\n'.join(svg),encoding='utf-8')
(HERE/'support_sections_v06.txt').write_text(identity+'\nActual capped section SVGs41-44/51/52; native rasterizer produces PNGs.\n',encoding='utf-8')
