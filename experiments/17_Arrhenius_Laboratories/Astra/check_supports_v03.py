...
prefixes=('Column_','Corbel','Beam_','EdgeBeam','StairHeader','StairRim','Pedestal_','FootingPad_','CoreBeamLedge',
...
lines.append('\nRIM TO FOUNDATION CONTACT PATHS: actual SAT gaps<=2mm; contacts do not establish bearing area or joint capacity.')
...
(HERE/'supports_v03.txt').write_text('\n'.join(lines)+'\n',encoding='utf-8')
