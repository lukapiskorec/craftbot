...
scene.render.filepath=str(HERE/'experiment_17_astra_v05_cycles_view_40_interior.png')
record={'geometry':runpy.run_path(str(HERE/'snapshot_v05.py'))['identity'](),
...
(HERE/'interior_v05_40_settings.json').write_text(json.dumps(record,indent=2),encoding='utf-8')
