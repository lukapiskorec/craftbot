...
scene.render.filepath=str(HERE/'experiment_17_astra_v07_cycles_view_40_interior.png')
record={'geometry':runpy.run_path(str(HERE/'snapshot_v07.py'))['identity'](),
...
(HERE/'interior_v07_40_settings.json').write_text(json.dumps(record,indent=2),encoding='utf-8')
