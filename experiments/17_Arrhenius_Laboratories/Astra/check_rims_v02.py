...
report='FROZEN v02 RIM/FRAME CONTACTS; standard SAT gap<=2mm; not bearing-area/capacity verification\n'
...
(HERE/'rim_contacts_v02.txt').write_text(report,encoding='utf-8')
