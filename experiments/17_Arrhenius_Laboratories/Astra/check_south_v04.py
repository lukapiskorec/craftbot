...
current=signatures()
bpy.ops.wm.open_mainfile(filepath=str(HERE/'preflight_v03.blend'))
prior=signatures()
...
rows=[runpy.run_path(str(HERE/'snapshot_v04.py'))['identity'](),f'Retained frame/floor/stair/insert signatures: {len(current)} current / {len(prior)} v03; changed {differences}']
