...
beams=[(o.name,hull(o)) for o in bpy.data.objects if o.type=='MESH' and o.name.startswith(('Beam_','StairHeader'))]
groups={}
for name,a in rims:
...
report=runpy.run_path(str(HERE/'snapshot_v06.py'))['identity']()+'\nFROZEN v06 RIM/FRAME CONTACTS; standard SAT gap<=2mm; not bearing-area/capacity verification\n'
...
(HERE/'rim_contacts_v06.txt').write_text(report,encoding='utf-8')
