...
Run in Blender after opening the saved v07 model; this does not alter geometry.
"""
...
tree=ast.parse((HERE/'experiment_17_astra_v07.py').read_text(encoding='utf-8'))
...
(HERE/'headroom_v07.txt').write_text(report,encoding='utf-8')
