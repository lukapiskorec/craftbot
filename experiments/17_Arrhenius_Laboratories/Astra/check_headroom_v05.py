...
Run in Blender after opening the saved v05 model; this does not alter geometry.
"""
...
tree=ast.parse((HERE/'experiment_17_astra_v05.py').read_text(encoding='utf-8'))
...
(HERE/'headroom_v05.txt').write_text(report,encoding='utf-8')
