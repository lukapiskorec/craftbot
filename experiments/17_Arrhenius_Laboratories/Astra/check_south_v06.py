...
rows=[runpy.run_path(str(HERE/'snapshot_v06.py'))['identity'](), 'Geometry changes are inventoried separately; no obsolete whole-frame retention assertion.']
...
rows.append(f'Bracket failures {failed}')
(HERE/'south_v06.txt').write_text('\n'.join(rows)+'\n',encoding='utf-8')
