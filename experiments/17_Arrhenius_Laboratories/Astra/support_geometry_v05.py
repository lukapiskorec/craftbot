"""Concept 8 support completion after the inherited v04 joinery.
...
def build_supports():
    ...
    fitted('CourtSubsoil','Foundation',32.85,35.60,89.50,90.10,-1.25,-.75)
    ...
    fitted('TerraceFill','Site/TerraceFill',18.85,35.15,96.30,106.90,0.,2.60)
    fitted('TerraceBase','Site/TerraceBase',18.85,35.15,96.30,106.90,2.60,2.75)
    # Prepared subsoil occupies only support footprints; existing foundations
    # take precedence throughout, including the retained south wall base.
    fitted('TerraceSubsoil_Interior','Foundation',18.85,35.15,96.30,106.90,-1.25,0.)
    for label,rect in [('W',(18.25,19.15,96.30,107.20)),
                       ('E',(34.85,35.75,96.30,107.20)),
                       ('N',(18.55,35.45,106.60,107.50)),
                       ('S',(18.55,35.45,95.70,96.60))]:
        fitted('TerraceSubsoil_'+label,'Foundation',*rect,-1.25,-.40)
    bpy.context.view_layer.update()
    print('Added concept8 perimeter ledgers, stair waist/seats and contained terrace support.',flush=True)
