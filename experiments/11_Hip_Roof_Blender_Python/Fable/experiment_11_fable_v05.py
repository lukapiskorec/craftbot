# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 11 (Fable run) - V05
...
print(f"[exp11 v05] Z_T0={Z_T0:.3f} Z_R={Z_R:.3f} HAP={HAP:.3f} dormer apex s={DORMER_GEOM[0]['s_apex']:.3f}")
print(f"[exp11 v05] objects: {len([o for o in bpy.data.objects if o.type == 'MESH'])}")
...
print(f"[exp11 v05] boards: {total_boards}")
