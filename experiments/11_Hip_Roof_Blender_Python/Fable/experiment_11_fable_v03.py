# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 11 (Fable run) - V03
# T-SHAPED HIP ROOF, SITE-FRAMED, WITH GABLE DORMERS AND CLOSED-METHOD
# WOOD-BOARD SHEATHING (v03 adds the boards, Fig. 98)
# ------------------------------------------------------------------
...
print(f"[exp11 v03] Z_T0={Z_T0:.3f} Z_R={Z_R:.3f} HAP={HAP:.3f} dormer apex s={DORMER_GEOM[0]['s_apex']:.3f}")
print(f"[exp11 v03] objects: {len([o for o in bpy.data.objects if o.type == 'MESH'])}")
...
print(f"[exp11 v03] boards: {total_boards}")
