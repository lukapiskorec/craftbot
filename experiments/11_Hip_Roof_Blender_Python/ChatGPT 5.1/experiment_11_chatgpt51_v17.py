# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 11 - CHATGPT 5.1 - V17
# HIP ROOF
# ------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# T-WING (SOUTH) – NOW A HIP ROOF ON THE SOUTH SIDE
# ---------------------------------------------------------------------------
...
def build_T_wing_rotated(main_geom,
    ...
    # Wing common rafters and jack rafters
    ...
    for i in range(n_steps + 1):
        ...
        if y >= y_ridge_start:  # normal common rafters to ridge
            ...
            # jack rafters bearing on hips
            # East hip from corner_SE to hip_top
            hip_p0_E = corner_SE
            hip_p1_E = hip_top
            ...
            # West hip from corner_SW to hip_top
            hip_p0_W = corner_SW
            hip_p1_W = hip_top
    ...
    # Valleys connecting to main roof (unchanged)
...
# ---------------------------------------------------------------------------
# DORMER BUILDER (unchanged from previous version)
# ---------------------------------------------------------------------------
