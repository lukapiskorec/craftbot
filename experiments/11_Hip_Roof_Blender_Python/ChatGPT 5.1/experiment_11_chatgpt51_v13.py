# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 11 - CHATGPT 5.1 - V13
# HIP ROOF
# ------------------------------------------------------------------
...
def build_dormer_on_north_slope(
    ...
    # ---------------------------------------------------------------
    # 1. (Window framing removed for clarity – only structural)
    # ---------------------------------------------------------------

    # ---------------------------------------------------------------
    # 2. Top plates (side plates only)
    # ---------------------------------------------------------------
    ...
    if num_dormer_jacks > 0:
        for j in range(num_dormer_jacks):
            ...
            box(
                name=f"Dormer_ValleyTopBrace_{j}",
