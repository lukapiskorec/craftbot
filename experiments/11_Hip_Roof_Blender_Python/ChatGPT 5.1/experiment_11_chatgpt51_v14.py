# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 11 - CHATGPT 5.1 - V14
# HIP ROOF
# ------------------------------------------------------------------
...
def build_dormer_on_north_slope(
    ...
    if num_dormer_jacks > 0:
        for j in range(num_dormer_jacks):
            ...
            brace_len_x = abs(P_valley_R.x - P_valley_L.x) * 0.8
...
def build_scene():
    ...
    center_offsets = [-3 * rafter_spacing, 0.0, 3 * rafter_spacing]  # [-1.8, 0, 1.8]
