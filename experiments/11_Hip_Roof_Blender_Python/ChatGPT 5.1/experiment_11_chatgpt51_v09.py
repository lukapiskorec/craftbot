# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 11 - CHATGPT 5.1 - V09
# HIP ROOF
# ------------------------------------------------------------------
...
# -----------------------------------------------------------
# GENERIC MEMBER CREATOR (used for main roof & T-wing)
# -----------------------------------------------------------
...
# -----------------------------------------------------------
# SOUTH T-WING (perpendicular gable with valleys)
# -----------------------------------------------------------
...
def build_T_wing_rotated(main_geom,
    ...
    # South valley geometry on main roof plane
...
def build_dormer_on_north_slope(
    ...
    # Host roof (north slope) from main_geom
    half_W = main_geom["half_W"]
    ridge_height = main_geom["ridge_height"]
    plate_z = main_geom["plate_z"]

    # ridge at y = 0, eave at y = +half_W
    y_main_ridge = 0.0
    z_main_ridge = ridge_height
    y_eave = half_W
    z_eave = plate_z

    # slope of north plane
    ...
    # ---------------------------------------------------------------
    # Base dormer dimensions (same as experiment_12)
    # ---------------------------------------------------------------
    ox, oy, oz = origin
    ...
    # ---------------------------------------------------------------
    # Main roof intersection geometry (using hip roof plane)
    # ---------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 3. Dormer ridge (slightly extended upslope)
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 5. X-grid used for double header (no extra host rafters)
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 6. Double header (line of intersection between dormer & host roof)
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 7. Valley rafters (back of dormer -> double header line)
    # ----------------------------------------------------------------
    rafter_between(
    ...
    # ----------------------------------------------------------------
    # 8. Jack rafters between valley rafters and dormer ridge
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 9. Front support beam at main roof plane
    # ----------------------------------------------------------------
    box(
    ...
    # ----------------------------------------------------------------
    # 10. Vertical studs from dormer rafters down to main roof
    # ----------------------------------------------------------------
    ...
    # ----------------------------------------------------------------
    # 11. Horizontal top braces tying dormer rafters
    # ----------------------------------------------------------------
...
def build_scene():
    ...
    slope_rise = 1.0
    slope_run = 2.0        # 1:2 slope (steeper)
    rafter_spacing = 0.6
    ...
    # Place dormer on north slope a bit upslope from the eave
    half_W = main_geom["half_W"]
    dormer_front_y = half_W - 0.8   # adjust as needed
    dormer_origin = (0.0, dormer_front_y, 0.0)
