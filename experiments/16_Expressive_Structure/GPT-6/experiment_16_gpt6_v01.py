# CRAFT BOT experiment 16, GPT-6 v01. Started from tools/experiment_template.py.
...
def cut_polyline(name, coll, nodes, y0, y1):
    ...
    for k, (p, q) in enumerate(zip(nodes, nodes[1:])):
        ...
        profile(f'{name}_{k:02d}', coll, strip_between(p, q, clips=[(p, n0), (q, n1)]), y0, y1)
...
print(f'Built Experiment16 GPT-6 v01: {MEMBER_COUNT} members; clear room3x3x6 m; 7 frames; 36 roof facets.')
