# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 08 - CHATGPT 5.1 - V13
# THE SEGAL METHOD
# ------------------------------------------------------------------
...
def build_porch_stair():
    ...
    n = 4
    total_rise = FLOOR0_BOTTOM + FLOOR_THICK  # from 0 up to deck top
    step_rise = total_rise / n
    step_depth = 0.25

    x_facade = Lx
    # East door is in middle Y-bay index 1
