# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 14 - Fable run, v08
...
for (k, face, along, a0, a1, b0, b1, z0, z1, ops) in TOWER_WALLS:
    if along == "x":
        ...
        board_rows(f"TowerIn_L{k}_{face}", CI, "x", a0, a1, bb[0], bb[1], z0, z1, CB_W, op_holes(ops, z0))
    else:
...
print(f"Built experiment 14 v08: {n} elements; L1 slab top {Z_L1}, terrace deck {Z_DECK_TOP:.3f}, "
