# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 14 - Fable run, v05
# Becher study: timber coaling tower refurbished as a multi-storey home.
#
# v05: CLT strips bear 50 mm on the beams and are notched around the
# interior posts (v04 slab edges ran 14 mm into the posts); ridge boards
# dropped by half their thickness times the slope so the last board row
# clears them; wall cladding stops under the rafter tails at the cladding
# face, not the wall face; tower cladding foot raised over the shed ridge.
#
...
CLAD_Z0 = max(z_beam(1)[0], RIDGE_Z + BOARD[1] * math.sqrt(1 + S * S) + 0.01)   # over the shed ridge boards
CLAD_Z1 = Z_TERR_GIRT
...
print(f"Built experiment 14 v05: {n} elements; L1 slab top {Z_L1}, terrace deck {Z_DECK_TOP:.3f}, "
