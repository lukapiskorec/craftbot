# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 14 - Fable run, v04
# Becher study: timber coaling tower refurbished as a multi-storey home.
#
# v04: head house cladding starts above the floor girts (it ran into
# them by its own thickness); trestle ties stop at the trestle girt face;
# no cross in the 0.3 m stub bay at the trestle top; no short-face braces
# at the L1 level (the shed ridge sits 50 mm under that girt); view hide
# lists and colours fixed to bare collection names (the v01-v03 renders
# of the frame-only and close-up views showed the cladding).
#
...
print(f"Built experiment 14 v04: {n} elements; L1 slab top {Z_L1}, terrace deck {Z_DECK_TOP:.3f}, "
