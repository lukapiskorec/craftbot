# ------------------------------------------------------------------
# CRAFT BOT - EXPERIMENT 09 - CHATGPT 5.1 - V14
# HOW TO CLT
# ------------------------------------------------------------------
...
def build_short_facades():
    ...
    for side_label in ('E', 'W'):
        ...
        for i in range(NUM_FLOORS):
            ...
            # build vertical piers between windows, along Y
            segments = []
            y_left = inside_y_min
            for c in centres:
                left  = c - window_half
...
def build_elevator_shafts():
    ...
    def build_shaft(tag, x_min_inner, x_max_inner, y_in_min_shaft, y_in_max_shaft):
        ...
        for i in range(NUM_FLOORS):
            ...
            # segments along Y around the door
...
def build_interior_walls_diagram():
    ...
    # N–S walls: shift 1 wall thickness towards centre
